...
class GenStressServerActor extends TypedActor[ServerMsg] {
  def typedReceive = {
...
class GenStressClientActor(queue:Int) extends TypedActor[ClientMessage] {
  var n:Int = 0
...
class GenStressTestActor extends TypedActor[TestorMsg] {
  var np:Int = 0
