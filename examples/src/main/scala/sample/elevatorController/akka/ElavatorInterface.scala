...
case object getState extends ElevatorMessage
//graphic elevator
case class Step(dir:Direction) extends ElevatorMessage
case object StopMessage extends ElevatorMessage
case class EPid(epid:ActorRef) extends ElevatorMessage

case class GEStateData (//StateDate for Graphic Elevator
    pos:Int, elevG:javax.swing.JPanel, elevator:ActorRef, dir:Direction, floors:List[(Floor, Int)]
    )
