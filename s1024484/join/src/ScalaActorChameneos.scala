...
//            println(i)
            ...
            if(numFaded == numChameneos) {
              ScalaActorChameneos.end = System.currentTimeMillis
              exit()
            }
          }
...
//    val N = 1000000//Integer.parseInt(args(0))
    ...
    ScalaActorChameneos.start = System.currentTimeMillis
