...
object join_pattern_test extends App{
  var messages : List[(AsyName[Int], Int)] = List()
...
//  val prop = forAll (ch_msg_gen_2) { ch_msg =>
  ...
  def test100(){
join.B(3); join.D(3); join.B(2); join.B(3); join.B(1); 
join.B(1); join.D(2); join.E(4); join.D(2); join.C(2); 
join.D(2); join.B(2); join.A(1); join.D(3); join.B(2); 
join.C(2); join.B(1); join.E(3); join.E(3); join.D(2); 
join.B(2); join.A(1); join.E(4); join.A(1); join.A(1); 
join.B(2); join.D(2); join.B(2); join.E(4); join.B(3); 
join.E(3); join.C(2); join.D(2); join.E(3); join.A(1); 
join.B(2); join.D(2); join.B(2); join.B(1); join.E(4); 
join.D(2); join.E(4); join.C(2); join.D(2); join.B(1); 
join.D(3); join.E(3); join.E(4); join.B(2); join.C(2); 
join.B(3); join.B(3); join.C(2); join.A(1); join.C(2); 
join.C(2); join.A(1); join.E(4); join.A(1); join.B(2); 
join.B(1); join.E(3); join.B(1); join.C(2); join.B(2); 
join.E(3); join.E(4); join.C(2); join.B(2); join.B(1); 
join.B(2); join.B(3); join.B(1); join.C(2); join.D(3); 
join.A(1); join.E(4); join.D(2); join.D(2); join.D(2); 
join.A(1); join.C(2); join.A(1); join.B(1); join.A(1); 
join.A(1); join.E(4); join.E(4); join.B(3); join.E(4); 
join.C(2); join.B(2); join.E(3); join.E(4); join.E(4); 
join.B(1); join.B(2); join.A(1); join.D(2); join.C(2); // 100 messages
  }
...
val start = java.lang.System.currentTimeMillis()  
  for ((channel,msg) <- messages) {channel(msg)}
