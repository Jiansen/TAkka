\section{Scala Join (version 0.3) User Manual}
\label{app_lib}
...
\subsubsection{Implementing the join pattern using extractor objects}
...
\subsubsection{Limited number of patterns in a single join definition}
