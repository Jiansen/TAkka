...
The {\tt become} method upgrades the behaviour of an  actor.  After the upgrade, the
...
Alternative to the actor model, different concurrent programming paradigms have been proposed.
