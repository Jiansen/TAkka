...
//import takka.cluster.MemberStatus._
...
// */
//// TODO: Check the type
//private[cluster] final class ClusterDomainEventPublisher extends TypedActor[Any] with ActorLogging {
...
//   */
//  def publishCurrentClusterState(receiver: Option[ActorRef[CurrentClusterState]]): Unit = {
...
//   */
//  def publishInstantClusterState(receiver: ActorRef[ClusterDomainEvent]): Unit =
...
//
//    eventStream.subscribe(subscriber.untypedRef, to)
//  }
//
//  def unsubscribe(subscriber: ActorRef[ClusterDomainEvent], to: Option[Class[_]]): Unit = to match {
//    case None    ⇒ eventStream.unsubscribe(subscriber.untypedRef)
//    case Some(c) ⇒ eventStream.unsubscribe(subscriber.untypedRef, c)
//  }
//
...
//            
//            // TODO: what is the effected of comment this line?
