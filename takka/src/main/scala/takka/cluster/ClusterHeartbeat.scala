...
//import akka.actor.{ ActorLogging, Address, RootActorPath, PoisonPill }
//import takka.actor.{ ActorRef, TypedActor, Props }
...
// * INTERNAL API
// */
//private[takka] object ClusterHeartbeatReceiver {
//  /**
...
// */
//private[cluster] final class ClusterHeartbeatReceiver extends TypedActor[ClusterMessage] with ActorLogging {
...
//private[cluster] final class ClusterHeartbeatSender extends TypedActor[_] with ActorLogging {
...
//    HeartbeatInterval, typedSelf, HeartbeatTick)
//
...
//      if (!cluster.failureDetector.isMonitoring(address))
//        scheduler.scheduleOnce(HeartbeatRequestDelay, typedSelf, SendHeartbeatRequest(address))
//    }
//
//  }
//
