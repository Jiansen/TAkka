...
//  override def get(system: ActorSystem): Cluster = super.get(system.system)
//
////  override def lookup = Cluster
//
//  override def createExtension(system: ActorSystem): Cluster = new Cluster(system)
//}
//
///**
...
// * }}}
// */
//class Cluster(val system: ActorSystem) {
//
...
//  private val log = Logging(system.system, "Cluster")
//
