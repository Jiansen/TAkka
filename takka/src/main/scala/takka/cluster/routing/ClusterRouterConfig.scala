...
//import takka.actor.ActorContext
...
//import takka.cluster.Cluster
//import takka.cluster.ClusterEvent._
//import takka.cluster.Member
//import takka.cluster.MemberStatus
...
//
//  override def createRouteeProvider(context: ActorContext[_], routeeProps: Props[_]) =
...
// */
//@SerialVersionUID(1L)
//case class ClusterRouterSettings private[takka] (
//  totalInstances: Int,
...
// */
//private[takka] class ClusterRouteeProvider[_](
//  _context: ActorContext[_],
//  _routeeProps: Props[_],
//  _resizer: Option[Resizer],
//  settings: ClusterRouterSettings)
//  extends RouteeProvider(_context.untypedContext, _routeeProps.props, _resizer) {
//
...
//              context.actorOf(routeeProps.withDeploy(deploy), name)
//          }
...
//        }
//
//      val (address, count) : (akka.actor.Address, 
// Int)= numberOfRouteesPerNode.minBy(_._2)
...
//   */
//  private[routing] def fullAddress(actorRef: akka.actor.ActorRef): Address = actorRef.path.address match {
...
// */
//private[takka] class ClusterRouterActor extends Router {
//
...
//  lazy val routeeProvider: ClusterRouteeProvider[Any] = ref.routeeProvider match {
//    case x: ClusterRouteeProvider[Any] ⇒ x
...
//
//  def fullAddress(actorRef: akka.actor.ActorRef): Address = routeeProvider.fullAddress(actorRef)
//
