...
//import takka.cluster.ClusterEvent.ClusterMetricsChanged
//import takka.cluster.ClusterEvent.CurrentClusterState
//import takka.cluster.NodeMetrics
//import takka.cluster.StandardMetrics.Cpu
//import takka.cluster.StandardMetrics.HeapMemory
...
//    val metricsListener = routeeProvider.context.actorOf(Props(new TypedActor[takka.cluster.ClusterEvent.ClusterDomainEvent] {
//
...
//
//    
//    // TODO: implement akka.routing
//    def getNext(): akka.actor.ActorRef = weightedRoutees match {
//      case Some(weighted) ⇒
//        if (weighted.isEmpty) routeeProvider.context.system.deadLetters
//        else weighted(ThreadLocalRandom.current.nextInt(weighted.total) + 1).untypedRef
//      case None ⇒
...
// */
//private[cluster] class WeightedRoutees(refs: IndexedSeq[ActorRef[_]], selfAddress: Address, weights: Map[Address, Int]) {
//
...
//    def fullAddress(actorRef: ActorRef[_]): Address = actorRef.path.address match {
...
//   */
//  def apply(value: Int): ActorRef[_] = {
