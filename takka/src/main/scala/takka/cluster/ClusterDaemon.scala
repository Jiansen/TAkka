...
//import akka.actor.{ ActorLogging, Address, Cancellable, PoisonPill, ReceiveTimeout, RootActorPath}
//import takka.actor.{ TypedActor, ActorRef, Props, Scheduler }
...
//   */
//  case class PublishCurrentClusterState(receiver: Option[ActorRef[CurrentClusterState]]) extends SubscriptionMessage
//
