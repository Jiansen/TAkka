...
class SessionGUI(session: ActorRef[ClientManagerMessage], pomdp: POMDP) extends Frame {
  ...
  override def closeOperation = session.untypedRef ! akka.actor.Kill // TODO: do something
