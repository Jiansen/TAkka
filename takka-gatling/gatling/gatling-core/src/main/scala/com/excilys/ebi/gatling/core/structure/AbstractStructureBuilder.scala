...
abstract class AbstractStructureBuilder[B <: AbstractStructureBuilder[B]](val actionBuilders: List[ActionBuilder]) {
	...
	protected def buildChainedActions(initialValue: ActorRef[Session], protocolConfigurationRegistry: ProtocolConfigurationRegistry): ActorRef[Session] = {

		@tailrec
		def buildChainedActions(actorRef: ActorRef[Session], actionBuilders: List[ActionBuilder], protocolConfigurationRegistry: ProtocolConfigurationRegistry): ActorRef[Session] = {
